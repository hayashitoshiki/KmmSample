...
import com.myapp.kmmsample.android.di.PreferencesComponentModule_ProvidePreferenceManagerFactory;
...
import com.myapp.presentation.viewmodel.SettingViewModel_HiltModules_KeyModule_ProvideFactory;
...
import com.myapp.ui.viewmodel.HomeViewModel_HiltModules_KeyModule_ProvideFactory;
import com.myapp.ui.viewmodel.SpendingTotalViewModel;
import com.myapp.ui.viewmodel.SpendingTotalViewModel_HiltModules_KeyModule_ProvideFactory;
import com.myapp.ui.viewmodel.WalletTotalViewModel;
import com.myapp.ui.viewmodel.WalletTotalViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC extends MyApplication_HiltComponents.SingletonC {
  ...
  private volatile Object preferenceManager = new MemoizedSentinel();
  ...
  private PreferenceManager preferenceManager() {
    Object local = preferenceManager;
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = preferenceManager;
        if (local instanceof MemoizedSentinel) {
          local = PreferencesComponentModule_ProvidePreferenceManagerFactory.providePreferenceManager(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
          preferenceManager = DoubleCheck.reentrantCheck(preferenceManager, local);
        }
      }
    }
    return (PreferenceManager) local;
  }

  private LocalCoinRepositoryImpl localCoinRepositoryImpl() {
    return new LocalCoinRepositoryImpl(preferenceManager());
  }

  private CoinUseCaseImpl coinUseCaseImpl() {
    return new CoinUseCaseImpl(localCoinRepositoryImpl());
  }
  ...
  public static final class Builder {
     ...
     */
    @Deprecated
    public Builder preferencesComponentModule(
        PreferencesComponentModule preferencesComponentModule) {
      Preconditions.checkNotNull(preferencesComponentModule);
      return this;
    }
  ...
  private static final class ActivityRetainedCImpl extends MyApplication_HiltComponents.ActivityRetainedC {
    ...
    private static final class ActivityCImpl extends MyApplication_HiltComponents.ActivityC {
      ...
      public Set<String> getViewModelKeys() {
        return SetBuilder.<String>newSetBuilder(4).add(HomeViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(SettingViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(SpendingTotalViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(WalletTotalViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
      }
    ...
    private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
      ...
      private volatile Provider<SpendingTotalViewModel> spendingTotalViewModelProvider;

      private volatile Provider<WalletTotalViewModel> walletTotalViewModelProvider;
      ...
      private HomeViewModel homeViewModel() {
        return new HomeViewModel(singletonC.coinUseCaseImpl());
      }
      ...
      private SettingViewModel settingViewModel() {
        return new SettingViewModel(singletonC.coinUseCaseImpl());
      }
      ...
      private SpendingTotalViewModel spendingTotalViewModel() {
        return new SpendingTotalViewModel(singletonC.coinUseCaseImpl());
      }

      private Provider<SpendingTotalViewModel> spendingTotalViewModelProvider() {
        Object local = spendingTotalViewModelProvider;
        if (local == null) {
          local = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 2);
          spendingTotalViewModelProvider = (Provider<SpendingTotalViewModel>) local;
        }
        return (Provider<SpendingTotalViewModel>) local;
      }

      private WalletTotalViewModel walletTotalViewModel() {
        return new WalletTotalViewModel(singletonC.coinUseCaseImpl());
      }

      private Provider<WalletTotalViewModel> walletTotalViewModelProvider() {
        Object local = walletTotalViewModelProvider;
        if (local == null) {
          local = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 3);
          walletTotalViewModelProvider = (Provider<WalletTotalViewModel>) local;
        }
        return (Provider<WalletTotalViewModel>) local;
      }

      @Override
      public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
        return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(4).put("com.myapp.ui.viewmodel.HomeViewModel", (Provider) homeViewModelProvider()).put("com.myapp.presentation.viewmodel.SettingViewModel", (Provider) settingViewModelProvider()).put("com.myapp.ui.viewmodel.SpendingTotalViewModel", (Provider) spendingTotalViewModelProvider()).put("com.myapp.ui.viewmodel.WalletTotalViewModel", (Provider) walletTotalViewModelProvider()).build();
      }
      ...
      private static final class SwitchingProvider<T> implements Provider<T> {
        ...
        public T get() {
          switch (id) {
            case 0: // com.myapp.ui.viewmodel.HomeViewModel 
            return (T) viewModelCImpl.homeViewModel();

            case 1: // com.myapp.presentation.viewmodel.SettingViewModel 
            return (T) viewModelCImpl.settingViewModel();

            case 2: // com.myapp.ui.viewmodel.SpendingTotalViewModel 
            return (T) viewModelCImpl.spendingTotalViewModel();

            case 3: // com.myapp.ui.viewmodel.WalletTotalViewModel 
            return (T) viewModelCImpl.walletTotalViewModel();
